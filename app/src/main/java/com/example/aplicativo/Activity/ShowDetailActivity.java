...
private ImageView plusBtn, minusBtn, picClever;
private CleverDomain object;
int numberOrder=1;
private ManagementCart managementCart;
    ...
    private void getBundle() {
        object=(CleverDomain) getIntent().getSerializableExtra("object");
        ...
        addToCartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                managementCart.insertClever(object);
            }
        });
    }
    ...
    private void initView(){
        ...
        picClever=findViewById(R.id.picclever);
