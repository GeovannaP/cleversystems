...
public class TinyDB {
    ...
    public ArrayList<CleverDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<CleverDomain> playerList =  new ArrayList<CleverDomain>();

        for(String jObjString : objStrings){
            CleverDomain player  = gson.fromJson(jObjString,  CleverDomain.class);
    ...
    public void putListObject(String key, ArrayList<CleverDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(CleverDomain player: playerList){
